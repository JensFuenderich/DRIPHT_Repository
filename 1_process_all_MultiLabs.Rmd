...
##### ATTENTION: In case of an error, the unzip function might not have worked (for me it actually unzips it, but still produces an error). If the next (!) chunk fails, go to the folder "data/raw/Direct_Replications/RRR_06" and manually unzip "Data_FINAL.zip".
