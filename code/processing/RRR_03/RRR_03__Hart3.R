...
convert_raw_data_Hart3_fun <- function(data, variable_info = NULL, output_folder){
  ...
  DV <- as.vector(unlist(lapply(data, function(data){data %>% dplyr::select(Intentionattr)})))
