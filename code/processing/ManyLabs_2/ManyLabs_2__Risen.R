...
# This version applies the subset used in meta-analysis of the ML2 publication.

convert_raw_data_Risen_fun <- function(data, variable_info = NULL, output_folder){
  ...
  Item_Level_before_cleaning <- data.frame(MultiLab = rep("ML2", length(dv_item_1)),
                                           MASC = rep("Risen", length(dv_item_1)),
