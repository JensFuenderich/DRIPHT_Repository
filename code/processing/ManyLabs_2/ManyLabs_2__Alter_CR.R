...
## This version uses a subset that is reduced to those sites that administered the test in English and as in-lab samples to achieve a close(r) replication.

convert_raw_data_Alter_CR_fun <- function(data, variable_info = NULL, output_folder){
